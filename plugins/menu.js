...
> *Hari*: %week
> *Tanggal*: %date
> *Tahun Baru*: %dateCountdown hari, %hours jam, %minutes menit, %seconds detik lagi!
...
let handler = async (m, { conn, usedPrefix: _p, args = [] }) => {
    try {
        ...
        let dateCountdown = moment('2027-01-01').diff(moment(), 'days');

        // Hitung sisa waktu menuju tahun baru 2027
