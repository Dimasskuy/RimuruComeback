const cooldown = 600000; // Cooldown default (10 menit dalam milidetik)
const cooldownAfterWork = 10 * 60 * 1000; // Cooldown setelah bekerja selama 10 menit (dalam milidetik)
